namespace RemindMeBot.Resources
{
    public static class ResourceKeys
    {
        ...
        public const string UserCurrentSettings = nameof(UserCurrentSettings);
        ...
        public const string AskSettingToChange = nameof(AskSettingToChange);
        public const string Language = nameof(Language);
        public const string Location = nameof(Location);
        public const string OptionListRetryPrompt = nameof(OptionListRetryPrompt);
